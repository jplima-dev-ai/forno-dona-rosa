...
### Foco visual da versão 2.0

- Hierarquia mobile-first para uma base de clientes majoritariamente móvel.
- Imagem de produto para todas as pizzas e bebidas.
- Cards compactos orientados por imagem e descoberta por desejo.
- Miniaturas na Sacola sem duplicar informação para leitores de tela.
- Assets WebP locais e carregamento preguiçoso abaixo da primeira dobra.
...
## Refinamento do repositório v2.1.9
