...
visual_css_path=ROOT/'css/visual-desire-v4.css'
home_bundle_path=ROOT/'css/home-bundle.css'
css=visual_css_path.read_text(encoding='utf-8') if visual_css_path.exists() else ''
bundle=home_bundle_path.read_text(encoding='utf-8') if home_bundle_path.exists() else ''
vm=(ROOT/'js/visual-media-v4.js').read_text(encoding='utf-8')
products=cat.get('products',[])

check('visual stylesheet exists',visual_css_path.exists())
...
check('visual css wired','css/visual-desire-v4.css' in html or 'source: css/visual-desire-v4.css' in bundle)
