...
if status.get('nvda')!='MANUAL_REQUIRED': fail.append('NVDA must remain MANUAL_REQUIRED until human test')
if fail:
...
print('Windows Playwright: 403 passed, 0 failed, 17 skipped. NVDA remains MANUAL_REQUIRED; published CWV remains pending.')
