...
check(status.get("releaseApproval") in {
    "PENDING_3_4_1_FINAL_EVIDENCE",
    "PENDING_PUBLISHED_CWV_EVIDENCE",
    "APPROVED_WITH_DECLARED_LIMITATIONS",
}, "release approval status is not an honest 3.4.1 state")
...
# Run the compatibility chain that protects the historical v4.x feature lineage.
