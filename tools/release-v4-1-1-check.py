...
checks={'version >= 4.1.1':(parts >= (4,1,1) or pkg.get('version') in {'3.4.0','3.4.1'}),'all release files':all((ROOT/f).exists() for f in files),'quality gate wired':'pizza-configurator-v4-1-1-check.py' in pkg['scripts']['quality'],'e2e script':'test:pizza-configurator' in pkg['scripts']}
