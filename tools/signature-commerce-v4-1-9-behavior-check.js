...
pass("release manifest refuses fake final approval",()=>assert(["PENDING_FINAL_EVIDENCE","PENDING_3.4.0_FINAL_EVIDENCE","PENDING_NVDA_AND_PUBLISHED_CWV_EVIDENCE"].includes(manifest.status.releaseApproval)));
