...
check('Primary nav reduced', 5 <= len(nav_links) <= 7 and 'href="menu/"' in nav_body and 'href="order/"' in nav_body, str(len(nav_links)))
...
check('Bag primary continuation copy', 'id="send-cart"' in html and '>Escolher entrega ou retirada</button>' in html)
