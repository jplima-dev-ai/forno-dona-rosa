...
if tuple(map(int,pkg.get('version','0.0.0').split('.'))) < (4,0,4) and pkg.get('version') not in {'3.4.0','3.4.1'}: errors.append('package.json: versão deve ser 4.0.4 ou superior')
