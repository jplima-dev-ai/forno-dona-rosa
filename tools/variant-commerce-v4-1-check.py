...
if errors:
    raise SystemExit(f"VARIANT COMMERCE 4.1.0 GATE: FAIL ({len(errors)} failures)")
print(f"VARIANT COMMERCE 4.1.0 GATE: PASS — {len(pizzas)} pizzas with explicit variants")
