...
test("credits survive normalization",()=>core.normalizeBundle(base).brand.credits.name==="Kael J Productions");
test("old bundle receives credit defaults",()=>{const old=core.clone(base);delete old.brand.credits;return core.normalizeBundle(old).brand.credits.name==="Kael J Productions";});
